...
class WCSCoords(CoordSystem):
    ...
    def __init__(self, ra: float = 0.0, dec: float = 0.0, frame: str = "icrs", unit: str = "deg") -> None:
        """
    ...
    def transform_to(self, frame: str) -> "WCSCoords":
        ...
        return WCSCoords(ra=transformed.ra.deg, dec=transformed.dec.deg, frame=frame)
