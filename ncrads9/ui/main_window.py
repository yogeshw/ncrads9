...
class MainWindow(QMainWindow):
    ...
    def _connect_menu_actions(self) -> None:
        ...
        self.edit.connect()
        self.undo.connect()
        # The shortcuts and the language are preferences, and the Edit
        # controller owns those.
        self.edit.apply_startup_preferences()
        self.view.connect()
    ...
    def _create_image_viewer(self, use_gpu: bool):
        ...
        viewer.viewport_resized.connect(self.zoom.on_viewport_resized)
